...
public class SalesDAO {
	...
	public void save(Sale sale) {
	    ...
	    insertActor.withTableName("sales").usingColumns("item_name", "quantity", "amount");
	...
	public void update(Sale sale) {
	    String sql = "UPDATE SALES SET item_name=:item_name, quantity=:quantity, amount=:amount WHERE id=:id";
	    BeanPropertySqlParameterSource param = new BeanPropertySqlParameterSource(sale);
